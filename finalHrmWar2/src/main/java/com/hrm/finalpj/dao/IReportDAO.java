...
public interface IReportDAO {
	...
	public List<ReportDTO> commentReadDAO(String num);  // 게시물 보기
	...
	public CommentDTO boardDAO(String num);  // 댓글 보기
	public int myReportCount(int num);  // 내 보고서 개수 세기
	public List<ReportDTO> myReportDAO(@Param("cri") Criteria criteria, int num);  // 내 보고서 보기
}
